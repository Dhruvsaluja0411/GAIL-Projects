        ...
        body: Center(
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                const Text("AstroChat",style: TextStyle(color: Colors.white, fontSize: 30),),
                Container(
                  ...
                  child: const CircleAvatar(
                    ...
                    radius: 135,
                    child: CircleAvatar(
                      backgroundImage: AssetImage('assets/images/astro.jpg'),
                      radius: 130,
                    ),
                  ),
                ),
                          ...
                          if (!_isAuthenticating)
                            ElevatedButton(
                              ...
                              style: ElevatedButton.styleFrom(
                                backgroundColor:
                                    const Color.fromARGB(255, 80, 72, 238),
                                foregroundColor:
